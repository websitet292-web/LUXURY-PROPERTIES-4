          ...
          <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div class="luxury-card p-5 sm:p-6">
              ...
              <button
                ...
                class="btn-gold-outline w-full py-3 text-xs mt-5"
              >
                ...
                ${properties.map(p => `
                  ...
                  <div class="bg-[#0d1119]/95 border border-[#1f2636] rounded-xl overflow-hidden">
                    ...
                    <div class="p-4">
                      ...
                      <div class="text-sm font-extrabold text-amber-400 mb-3">
                        ${formatLKR(p.price)}
                      </div>

                      <button
                        onclick="navigate('#/properties')"
                        class="btn-gold-outline w-full py-2 text-[11px]"
                      >
                        View Details
                      </button>
...
<div class="absolute inset-0 overflow-hidden">
  ...
  <div class="absolute inset-0 bg-gradient-to-r from-black/90 via-black/45 to-black/80"></div>
      ...
      <div class="relative z-10 luxury-card border border-amber-400/30 w-[260px] p-3 bg-black/20 shadow-2xl backdrop-blur-md rounded-3xl mx-auto translate-y-4">
